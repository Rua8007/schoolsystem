class GradeGroupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @grade_group.save
        format.html { redirect_to grade_groups_path, notice: 'Grade group was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @grade_group.update(grade_group_params)
        format.html { redirect_to grade_groups_path, notice: 'Grade group was successfully updated.' }
  ...
  private
    ...
    def grade_group_params
      params.require(:grade_group).permit(:name)
    end
end
