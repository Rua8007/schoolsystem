...
class PerformancesControllerTest < ActionController::TestCase
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post :create, performance: { bridge_id: @performance.bridge_id, remark: @performance.remark, student_id: @performance.student_id }
    end
  ...
  test "should update performance" do
    patch :update, id: @performance, performance: { bridge_id: @performance.bridge_id, remark: @performance.remark, student_id: @performance.student_id }
    assert_redirected_to performance_path(assigns(:performance))
  end
