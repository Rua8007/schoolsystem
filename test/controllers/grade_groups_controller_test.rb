...
class GradeGroupsControllerTest < ActionController::TestCase
  ...
  test "should create grade_group" do
    assert_difference('GradeGroup.count') do
      post :create, grade_group: { grade_id: @grade_group.grade_id, integer: @grade_group.integer, name: @grade_group.name }
    end
  ...
  test "should update grade_group" do
    patch :update, id: @grade_group, grade_group: { grade_id: @grade_group.grade_id, integer: @grade_group.integer, name: @grade_group.name }
    assert_redirected_to grade_group_path(assigns(:grade_group))
  end
