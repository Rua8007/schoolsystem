...
class CalendersControllerTest < ActionController::TestCase
  ...
  test "should create calender" do
    assert_difference('Calender.count') do
      post :create, calender: { description: @calender.description, endtime: @calender.endtime, starttime: @calender.starttime, title: @calender.title }
    end
  ...
  test "should update calender" do
    patch :update, id: @calender, calender: { description: @calender.description, endtime: @calender.endtime, starttime: @calender.starttime, title: @calender.title }
    assert_redirected_to calender_path(assigns(:calender))
  end
